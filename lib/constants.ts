...
export const MOCK_SLIDES = [
  { id: 'brand_funnel', title: 'Brand Funnel Analysis', description: 'Conversion rates through awareness stages', tag: 'Brand Funnel' },
  { id: 'key_driver', title: 'Key Driver Analysis', description: 'Relative importance of brand attributes', tag: 'Key Driver' },
  { id: 'nps', title: 'NPS Distribution', description: 'Net Promoter Score breakdown by segment', tag: 'NPS Analysis' },
  { id: 'trend', title: 'Trend Analysis', description: 'Wave-over-wave performance tracking', tag: 'Trend Line' },
  { id: 'heatmap', title: 'Satisfaction Heatmap', description: 'Satisfaction scores across demographics', tag: 'Heatmap' },
];
...
export const CLEANUP_FLAGS = [
  { row: 2, column: 'BrandA_Price', issue: 'Outlier detected: price is 20% higher than average.'},
  { row: 5, column: 'Gender', issue: 'Inconsistent value: "Non-binary" vs categorical "Male"/"Female". Suggest re-coding.'},
  { row: 7, column: 'Purchase', issue: 'Straight-liner: User selected "1" for all funnel stages but did not purchase.'},
];
